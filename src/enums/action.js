...
export const ActionTab = Object.freeze({
   ...
   typeNavigateTab: process.env.REACT_APP_TYPE_MESSAGE_NEVIGATE_URL,

   typePinTab: process.env.REACT_APP_TYPE_MESSAGE_PIN_STATUS_CHANGED,
   ...
   typeChangeStateCollection: process.env.REACT_APP_TYPE_NAME_STATE_COLLECTION,
});
